...
const questions = [
    {
        ...
        options: ["High Tech Modern Language", "Hyper Text Markup Language", "Hyper Transfer Markup Language"],
        correct_index: 1
    },
    {
        jsquestion: "Which HTML element is used for the largest heading?",
        options: ["<heading>", "<h1>", "<head>"],
        correct_index: 1
    },
    {
        jsquestion: "What is the correct HTML for creating a hyperlink?",
        options: ["<a href='url'>Link</a>", "<link>url</link>", "<a url='href'>Link</a>"],
        correct_index: 0
    },
    {
        jsquestion: "Which HTML attribute is used to define inline styles?",
        options: ["class", "styles", "style"],
        correct_index: 2
    },
    {
        jsquestion: "In HTML, which element is used to specify a footer for a document?",
        options: ["<bottom>", "<footer>", "<section>"],
        correct_index: 1
    }
];
...
function showResult(){
    ...
    categoriesButton.style.marginTop = "15px";
