...
const questions = [
    ...
    {
        jsquestion: "Which method is used to add an element to the end of an array?",
        options: ["push()", "unshift()", "pop()"],
        correct_index: 0
    },
    {
        jsquestion: "How do you declare a JavaScript variable?",
        options: ["variable x", "var x", "v x"],
        correct_index: 1
    },
    {
        jsquestion: "Which operator is used for strict equality comparison?",
        options: ["==", "===", "="],
        correct_index: 1
    },
    {
        jsquestion: "What will Boolean(0) return?",
...
function showResult(){
    ...
    scorePara.style.marginTop = "10px";
